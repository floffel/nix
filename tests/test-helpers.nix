...

{
  ...
  systemd.services.test-secrets = {
    ...
    script = ''
      ...
      # parsedmarc reads reports from the postmaster Maildir directly (no
      # IMAP/SMTP secrets); the rspamd controller password is generated by
      # the mail-rspamd-password oneshot.
