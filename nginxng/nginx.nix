...
in
{
  ...
  services.nginx = {
    ...
    upstreams = {
      ...
      bitwarden_ws.servers = { "pod:3012" = {}; };
      matrix.servers = { "172.16.16.12:8008" = {}; };
      ntfy.servers = { "172.16.16.12:2580" = {}; };
      code.servers = { "10.0.40.1:9980" = {}; };
      ju.servers = { "pod:8004" = {}; };
      jitsy.servers = { "10.0.40.1:8000" = {}; };
      authentik.servers = { "pod:9000" = {}; };
      career.servers = { "10.0.100.1:8080" = {}; };
      graf.servers = { "pod:3000" = {}; };
      tooljet.servers = { "pod:7070" = {}; };
      ...
      "tex.minnecker.com" = {
        ...
        locations."/" = {
          ...
          extraConfig = ''
            ...
            proxy_buffering off;
            error_log /var/log/nginx/tex.error.log;
          '';
        };
        extraConfig = ''
          charset utf-8;
  ...
  services.roundcube = {
    ...
    extraConfig = ''
      ...
      $config['db_dsnw'] = "pgsql://roundcube:$db_password@postgresqlng/roundcube";
      ...
      $config['imap_host'] = 'backendmailng:143';
      $config['smtp_host'] = 'backendmailng:587';
